...
import NotionBlogCarousel from './NotionBlogCarousel';

const NotionBlogPreview = () => {
  return (
    <section className='space-y-6'>
      <div className='flex items-center justify-between'>
        <SectionHeading title='Latest Notion Articles' className='ml-1' />
        <SectionSubHeading>
...
export default NotionBlogPreview;
